...
void atacar_chimpoco(int selected_chimpoco[], int enemigo[],bool &game_over,int cont_turnos,bool &congelado,bool &chimpoco_aturdido,bool &enemigo_control,bool &irritado,int estadisticas[][S],int aventura){
    //llamo pasiva
    ...
    estadisticas[aventura][DANIO_REALIZADO] += selected_chimpoco[ATAQUE_ACTUAL];
...
void atacar_enemigo(int selected_chimpoco[], int enemigo[],bool &game_over,int cont_turnos,bool &congelado,bool &chimpoco_aturdido,bool &enemigo_control,bool &irritado,int estadisticas[][S],int aventura){
    //llamo pasiva
    if(selected_chimpoco[PASIVA] == 1){pasiva_chimpoco(selected_chimpoco,enemigo,cont_turnos,congelado);}
    if(enemigo[PASIVA] != 3){pasiva_enemigo(enemigo,cont_turnos,chimpoco_aturdido,selected_chimpoco,enemigo_control,irritado);}
    selected_chimpoco[VIDA_ACTUAL] -= enemigo[ATAQUE_ACTUAL];
    estadisticas[aventura][DANIO_RECIBIDO] += enemigo[ATAQUE_ACTUAL];
